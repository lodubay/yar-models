...
class twoinfall(double_exponential):
    ...
    second_timescale : float [default: 15.0]
        The timescale of the second exponential infall in Gyr at R = 8 kpc.
        The final timescale scales exponentially with radius.
    scale_radius : float [default: 7.0]
        Scale radius of the second infall timescale in kpc.
    ...
    def __init__(
        ...
        self.second.timescale = second_timescale * m.exp(
            (radius - 8) / scale_radius
        )
