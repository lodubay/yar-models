"""
This file sets the Solar-scaled nucleosynthetic yields according to y/Zsun=1.
"""
import vice

SOLAR_SCALE = 1.0 # y_O / Z_O,Sun
AFE_CC = 0.45 # CCSN [a/Fe] plateau
YIA_SCALE = 1.2 # arbitrary scaling of yIa to adjust chemical evolution endpoint
